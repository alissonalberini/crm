    ...
    <table class="table">
        ...
        <div class="col-xs-10">
            <div class="form-group">
                <form method="POST" action="{{ url('/imobiles/upload', $imobile->id)}}" class="dropzone" id="dropzone"
                      files="true" data-dz-removea enctype="multipart/form-data">
        ...
        <tbody>
        @foreach($imobile->documents as $document)
            <tr>
