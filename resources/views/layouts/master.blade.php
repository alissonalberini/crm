...
<div id="wrapper">
    ...
    <div class="navbar navbar-default navbar-top" style="background-color: #35b3c1">
        <!--NOTIFICATIONS START-->
<div class="menu">
  ...
  if ($('.menu').hasClass('bar')) {
    ...
    <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation">
        <div class="list-group panel">
            ...
            <p class=" list-group-item siderbar-top" title=""><img src="{{url('images/crm_logo.png')}}" alt=""></p>
            ...
            <a href="#indications" class=" list-group-item" data-toggle="collapse" data-parent="#MainMenu"><i
                        class="sidebar-icon glyphicon glyphicon-list-alt"></i><span id="menu-txt">{{ __('Indications') }}</span>
            <i class="ion-chevron-up  arrow-up sidebar-arrow"></i></a>
            <div class="collapse" id="indications">
                <a href="{{ route('indications.index')}}"
                   class="list-group-item childlist">{{ __('All Indications') }}</a>
