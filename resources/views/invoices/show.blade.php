...
@endif
        ...
        @if(!$invoice->payment_received_at)
                ...
                {!! Form::submit(__('Set invoice as paid'), ['class' => 'btn btn-success form-control closebtn']) !!}
        </div>
        {!! Form::close() !!}
        @else
            {!! Form::open([
            ...
            {!! Form::submit(__('Set invoice as not paid'), ['class' => 'btn btn-danger form-control closebtn']) !!}
            {!! Form::close() !!}
        @endif
        @endif
    </div>
